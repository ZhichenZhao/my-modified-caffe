...
class CtxDataParameter;
class CtxDataParameterDefaultTypeInternal;
extern CtxDataParameterDefaultTypeInternal _CtxDataParameter_default_instance_;
class DataParameter;
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 public:
  ...
  // optional .caffe.CtxDataParameter ctx_data_param = 150;
  bool has_ctx_data_param() const;
  void clear_ctx_data_param();
  static const int kCtxDataParamFieldNumber = 150;
  const ::caffe::CtxDataParameter& ctx_data_param() const;
  ::caffe::CtxDataParameter* mutable_ctx_data_param();
  ::caffe::CtxDataParameter* release_ctx_data_param();
  void set_allocated_ctx_data_param(::caffe::CtxDataParameter* ctx_data_param);
 ...
 private:
  ...
  void set_has_ctx_data_param();
  void clear_has_ctx_data_param();
  ...
  ::caffe::CtxDataParameter* ctx_data_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_InitDefaults_caffe_2eproto_impl();
  friend void  protobuf_AddDesc_caffe_2eproto_impl();
...
class CtxDataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.CtxDataParameter) */ {
 public:
  CtxDataParameter();
  virtual ~CtxDataParameter();

  CtxDataParameter(const CtxDataParameter& from);

  inline CtxDataParameter& operator=(const CtxDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CtxDataParameter& default_instance();

  static inline const CtxDataParameter* internal_default_instance() {
    return reinterpret_cast<const CtxDataParameter*>(
               &_CtxDataParameter_default_instance_);
  }

  void Swap(CtxDataParameter* other);

  // implements Message ----------------------------------------------

  inline CtxDataParameter* New() const PROTOBUF_FINAL { return New(NULL); }

  CtxDataParameter* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const CtxDataParameter& from);
  void MergeFrom(const CtxDataParameter& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(CtxDataParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // optional string root_folder_bbox = 12 [default = ""];
  bool has_root_folder_bbox() const;
  void clear_root_folder_bbox();
  static const int kRootFolderBboxFieldNumber = 12;
  const ::std::string& root_folder_bbox() const;
  void set_root_folder_bbox(const ::std::string& value);
  void set_root_folder_bbox(const char* value);
  void set_root_folder_bbox(const char* value, size_t size);
  ::std::string* mutable_root_folder_bbox();
  ::std::string* release_root_folder_bbox();
  void set_allocated_root_folder_bbox(::std::string* root_folder_bbox);

  // optional string root_folder_ctx = 13 [default = ""];
  bool has_root_folder_ctx() const;
  void clear_root_folder_ctx();
  static const int kRootFolderCtxFieldNumber = 13;
  const ::std::string& root_folder_ctx() const;
  void set_root_folder_ctx(const ::std::string& value);
  void set_root_folder_ctx(const char* value);
  void set_root_folder_ctx(const char* value, size_t size);
  ::std::string* mutable_root_folder_ctx();
  ::std::string* release_root_folder_ctx();
  void set_allocated_root_folder_ctx(::std::string* root_folder_ctx);

  // optional uint32 num_scales = 15 [default = 224];
  bool has_num_scales() const;
  void clear_num_scales();
  static const int kNumScalesFieldNumber = 15;
  ::google::protobuf::uint32 num_scales() const;
  void set_num_scales(::google::protobuf::uint32 value);

  // optional float jit_scale = 14 [default = 224];
  bool has_jit_scale() const;
  void clear_jit_scale();
  static const int kJitScaleFieldNumber = 14;
  float jit_scale() const;
  void set_jit_scale(float value);

  // @@protoc_insertion_point(class_scope:caffe.CtxDataParameter)
 private:
  void set_has_source();
  void clear_has_source();
  void set_has_batch_size();
  ...
  void set_has_mirror();
  void clear_has_mirror();
  void set_has_root_folder_bbox();
  void clear_has_root_folder_bbox();
  void set_has_root_folder_ctx();
  void clear_has_root_folder_ctx();
  void set_has_num_scales();
  void clear_has_num_scales();
  void set_has_jit_scale();
  void clear_has_jit_scale();
  ...
  ::google::protobuf::internal::ArenaStringPtr source_;
  ::google::protobuf::internal::ArenaStringPtr mean_file_;
  ::google::protobuf::internal::ArenaStringPtr root_folder_bbox_;
  ::google::protobuf::internal::ArenaStringPtr root_folder_ctx_;
  ::google::protobuf::uint32 rand_skip_;
  ::google::protobuf::uint32 new_height_;
  ::google::protobuf::uint32 new_width_;
  bool shuffle_;
...
// optional .caffe.CtxDataParameter ctx_data_param = 150;
inline bool LayerParameter::has_ctx_data_param() const {
  return (_has_bits_[1] & 0x00020000u) != 0;
}
inline void LayerParameter::set_has_ctx_data_param() {
  _has_bits_[1] |= 0x00020000u;
}
inline void LayerParameter::clear_has_ctx_data_param() {
  _has_bits_[1] &= ~0x00020000u;
}
inline void LayerParameter::clear_ctx_data_param() {
  if (ctx_data_param_ != NULL) ctx_data_param_->::caffe::CtxDataParameter::Clear();
  clear_has_ctx_data_param();
}
inline const ::caffe::CtxDataParameter& LayerParameter::ctx_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.ctx_data_param)
  return ctx_data_param_ != NULL ? *ctx_data_param_
                         : *::caffe::CtxDataParameter::internal_default_instance();
}
inline ::caffe::CtxDataParameter* LayerParameter::mutable_ctx_data_param() {
  set_has_ctx_data_param();
  if (ctx_data_param_ == NULL) {
    ctx_data_param_ = new ::caffe::CtxDataParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.ctx_data_param)
  return ctx_data_param_;
}
inline ::caffe::CtxDataParameter* LayerParameter::release_ctx_data_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.ctx_data_param)
  clear_has_ctx_data_param();
  ::caffe::CtxDataParameter* temp = ctx_data_param_;
  ctx_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_ctx_data_param(::caffe::CtxDataParameter* ctx_data_param) {
  delete ctx_data_param_;
  ctx_data_param_ = ctx_data_param;
  if (ctx_data_param) {
    set_has_ctx_data_param();
  } else {
    clear_has_ctx_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.ctx_data_param)
}
...
// optional string source = 1;
inline bool CtxDataParameter::has_source() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CtxDataParameter::set_has_source() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CtxDataParameter::clear_has_source() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CtxDataParameter::clear_source() {
  source_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_source();
}
inline const ::std::string& CtxDataParameter::source() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.source)
  return source_.GetNoArena();
}
inline void CtxDataParameter::set_source(const ::std::string& value) {
  set_has_source();
  source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.source)
}
inline void CtxDataParameter::set_source(const char* value) {
  set_has_source();
  source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.CtxDataParameter.source)
}
inline void CtxDataParameter::set_source(const char* value, size_t size) {
  set_has_source();
  source_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.CtxDataParameter.source)
}
inline ::std::string* CtxDataParameter::mutable_source() {
  set_has_source();
  // @@protoc_insertion_point(field_mutable:caffe.CtxDataParameter.source)
  return source_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CtxDataParameter::release_source() {
  // @@protoc_insertion_point(field_release:caffe.CtxDataParameter.source)
  clear_has_source();
  return source_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void CtxDataParameter::set_allocated_source(::std::string* source) {
  if (source != NULL) {
    set_has_source();
  } else {
    clear_has_source();
  ...
  source_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), source);
  // @@protoc_insertion_point(field_set_allocated:caffe.CtxDataParameter.source)
}

// optional uint32 batch_size = 4 [default = 1];
inline bool CtxDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void CtxDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000800u;
}
inline void CtxDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void CtxDataParameter::clear_batch_size() {
  batch_size_ = 1u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 CtxDataParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.batch_size)
  return batch_size_;
}
inline void CtxDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.batch_size)
}

// optional uint32 rand_skip = 7 [default = 0];
inline bool CtxDataParameter::has_rand_skip() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void CtxDataParameter::set_has_rand_skip() {
  _has_bits_[0] |= 0x00000010u;
}
inline void CtxDataParameter::clear_has_rand_skip() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void CtxDataParameter::clear_rand_skip() {
  rand_skip_ = 0u;
  clear_has_rand_skip();
}
inline ::google::protobuf::uint32 CtxDataParameter::rand_skip() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.rand_skip)
  return rand_skip_;
}
inline void CtxDataParameter::set_rand_skip(::google::protobuf::uint32 value) {
  set_has_rand_skip();
  rand_skip_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.rand_skip)
}

// optional bool shuffle = 8 [default = false];
inline bool CtxDataParameter::has_shuffle() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void CtxDataParameter::set_has_shuffle() {
  _has_bits_[0] |= 0x00000080u;
}
inline void CtxDataParameter::clear_has_shuffle() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void CtxDataParameter::clear_shuffle() {
  shuffle_ = false;
  clear_has_shuffle();
}
inline bool CtxDataParameter::shuffle() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.shuffle)
  return shuffle_;
}
inline void CtxDataParameter::set_shuffle(bool value) {
  set_has_shuffle();
  shuffle_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.shuffle)
}

// optional uint32 new_height = 9 [default = 0];
inline bool CtxDataParameter::has_new_height() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void CtxDataParameter::set_has_new_height() {
  _has_bits_[0] |= 0x00000020u;
}
inline void CtxDataParameter::clear_has_new_height() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void CtxDataParameter::clear_new_height() {
  new_height_ = 0u;
  clear_has_new_height();
}
inline ::google::protobuf::uint32 CtxDataParameter::new_height() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.new_height)
  return new_height_;
}
inline void CtxDataParameter::set_new_height(::google::protobuf::uint32 value) {
  set_has_new_height();
  new_height_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.new_height)
}

// optional uint32 new_width = 10 [default = 0];
inline bool CtxDataParameter::has_new_width() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void CtxDataParameter::set_has_new_width() {
  _has_bits_[0] |= 0x00000040u;
}
inline void CtxDataParameter::clear_has_new_width() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void CtxDataParameter::clear_new_width() {
  new_width_ = 0u;
  clear_has_new_width();
}
inline ::google::protobuf::uint32 CtxDataParameter::new_width() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.new_width)
  return new_width_;
}
inline void CtxDataParameter::set_new_width(::google::protobuf::uint32 value) {
  set_has_new_width();
  new_width_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.new_width)
}

// optional bool is_color = 11 [default = true];
inline bool CtxDataParameter::has_is_color() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void CtxDataParameter::set_has_is_color() {
  _has_bits_[0] |= 0x00001000u;
}
inline void CtxDataParameter::clear_has_is_color() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void CtxDataParameter::clear_is_color() {
  is_color_ = true;
  clear_has_is_color();
}
inline bool CtxDataParameter::is_color() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.is_color)
  return is_color_;
}
inline void CtxDataParameter::set_is_color(bool value) {
  set_has_is_color();
  is_color_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.is_color)
}

// optional float scale = 2 [default = 1];
inline bool CtxDataParameter::has_scale() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void CtxDataParameter::set_has_scale() {
  _has_bits_[0] |= 0x00002000u;
}
inline void CtxDataParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void CtxDataParameter::clear_scale() {
  scale_ = 1;
  clear_has_scale();
}
inline float CtxDataParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.scale)
  return scale_;
}
inline void CtxDataParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.scale)
}

// optional string mean_file = 3;
inline bool CtxDataParameter::has_mean_file() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void CtxDataParameter::set_has_mean_file() {
  _has_bits_[0] |= 0x00000002u;
}
inline void CtxDataParameter::clear_has_mean_file() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void CtxDataParameter::clear_mean_file() {
  mean_file_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_mean_file();
}
inline const ::std::string& CtxDataParameter::mean_file() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.mean_file)
  return mean_file_.GetNoArena();
}
inline void CtxDataParameter::set_mean_file(const ::std::string& value) {
  set_has_mean_file();
  mean_file_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.mean_file)
}
inline void CtxDataParameter::set_mean_file(const char* value) {
  set_has_mean_file();
  mean_file_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.CtxDataParameter.mean_file)
}
inline void CtxDataParameter::set_mean_file(const char* value, size_t size) {
  set_has_mean_file();
  mean_file_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.CtxDataParameter.mean_file)
}
inline ::std::string* CtxDataParameter::mutable_mean_file() {
  set_has_mean_file();
  // @@protoc_insertion_point(field_mutable:caffe.CtxDataParameter.mean_file)
  return mean_file_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CtxDataParameter::release_mean_file() {
  // @@protoc_insertion_point(field_release:caffe.CtxDataParameter.mean_file)
  clear_has_mean_file();
  return mean_file_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void CtxDataParameter::set_allocated_mean_file(::std::string* mean_file) {
  if (mean_file != NULL) {
    set_has_mean_file();
  } else {
    clear_has_mean_file();
  ...
  mean_file_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), mean_file);
  // @@protoc_insertion_point(field_set_allocated:caffe.CtxDataParameter.mean_file)
}

// optional uint32 crop_size = 5 [default = 0];
inline bool CtxDataParameter::has_crop_size() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void CtxDataParameter::set_has_crop_size() {
  _has_bits_[0] |= 0x00000200u;
}
inline void CtxDataParameter::clear_has_crop_size() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void CtxDataParameter::clear_crop_size() {
  crop_size_ = 0u;
  clear_has_crop_size();
}
inline ::google::protobuf::uint32 CtxDataParameter::crop_size() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.crop_size)
  return crop_size_;
}
inline void CtxDataParameter::set_crop_size(::google::protobuf::uint32 value) {
  set_has_crop_size();
  crop_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.crop_size)
}

// optional bool mirror = 6 [default = false];
inline bool CtxDataParameter::has_mirror() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void CtxDataParameter::set_has_mirror() {
  _has_bits_[0] |= 0x00000100u;
}
inline void CtxDataParameter::clear_has_mirror() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void CtxDataParameter::clear_mirror() {
  mirror_ = false;
  clear_has_mirror();
}
inline bool CtxDataParameter::mirror() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.mirror)
  return mirror_;
}
inline void CtxDataParameter::set_mirror(bool value) {
  set_has_mirror();
  mirror_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.mirror)
}

// optional string root_folder_bbox = 12 [default = ""];
inline bool CtxDataParameter::has_root_folder_bbox() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void CtxDataParameter::set_has_root_folder_bbox() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CtxDataParameter::clear_has_root_folder_bbox() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void CtxDataParameter::clear_root_folder_bbox() {
  root_folder_bbox_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_root_folder_bbox();
}
inline const ::std::string& CtxDataParameter::root_folder_bbox() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.root_folder_bbox)
  return root_folder_bbox_.GetNoArena();
}
inline void CtxDataParameter::set_root_folder_bbox(const ::std::string& value) {
  set_has_root_folder_bbox();
  root_folder_bbox_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.root_folder_bbox)
}
inline void CtxDataParameter::set_root_folder_bbox(const char* value) {
  set_has_root_folder_bbox();
  root_folder_bbox_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.CtxDataParameter.root_folder_bbox)
}
inline void CtxDataParameter::set_root_folder_bbox(const char* value, size_t size) {
  set_has_root_folder_bbox();
  root_folder_bbox_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.CtxDataParameter.root_folder_bbox)
}
inline ::std::string* CtxDataParameter::mutable_root_folder_bbox() {
  set_has_root_folder_bbox();
  // @@protoc_insertion_point(field_mutable:caffe.CtxDataParameter.root_folder_bbox)
  return root_folder_bbox_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CtxDataParameter::release_root_folder_bbox() {
  // @@protoc_insertion_point(field_release:caffe.CtxDataParameter.root_folder_bbox)
  clear_has_root_folder_bbox();
  return root_folder_bbox_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void CtxDataParameter::set_allocated_root_folder_bbox(::std::string* root_folder_bbox) {
  if (root_folder_bbox != NULL) {
    set_has_root_folder_bbox();
  } else {
    clear_has_root_folder_bbox();
  }
  root_folder_bbox_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), root_folder_bbox);
  // @@protoc_insertion_point(field_set_allocated:caffe.CtxDataParameter.root_folder_bbox)
}

// optional string root_folder_ctx = 13 [default = ""];
inline bool CtxDataParameter::has_root_folder_ctx() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void CtxDataParameter::set_has_root_folder_ctx() {
  _has_bits_[0] |= 0x00000008u;
}
inline void CtxDataParameter::clear_has_root_folder_ctx() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void CtxDataParameter::clear_root_folder_ctx() {
  root_folder_ctx_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_root_folder_ctx();
}
inline const ::std::string& CtxDataParameter::root_folder_ctx() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.root_folder_ctx)
  return root_folder_ctx_.GetNoArena();
}
inline void CtxDataParameter::set_root_folder_ctx(const ::std::string& value) {
  set_has_root_folder_ctx();
  root_folder_ctx_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.root_folder_ctx)
}
inline void CtxDataParameter::set_root_folder_ctx(const char* value) {
  set_has_root_folder_ctx();
  root_folder_ctx_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:caffe.CtxDataParameter.root_folder_ctx)
}
inline void CtxDataParameter::set_root_folder_ctx(const char* value, size_t size) {
  set_has_root_folder_ctx();
  root_folder_ctx_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:caffe.CtxDataParameter.root_folder_ctx)
}
inline ::std::string* CtxDataParameter::mutable_root_folder_ctx() {
  set_has_root_folder_ctx();
  // @@protoc_insertion_point(field_mutable:caffe.CtxDataParameter.root_folder_ctx)
  return root_folder_ctx_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CtxDataParameter::release_root_folder_ctx() {
  // @@protoc_insertion_point(field_release:caffe.CtxDataParameter.root_folder_ctx)
  clear_has_root_folder_ctx();
  return root_folder_ctx_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void CtxDataParameter::set_allocated_root_folder_ctx(::std::string* root_folder_ctx) {
  if (root_folder_ctx != NULL) {
    set_has_root_folder_ctx();
  } else {
    clear_has_root_folder_ctx();
  }
  root_folder_ctx_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), root_folder_ctx);
  // @@protoc_insertion_point(field_set_allocated:caffe.CtxDataParameter.root_folder_ctx)
}

// optional uint32 num_scales = 15 [default = 224];
inline bool CtxDataParameter::has_num_scales() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void CtxDataParameter::set_has_num_scales() {
  _has_bits_[0] |= 0x00004000u;
}
inline void CtxDataParameter::clear_has_num_scales() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void CtxDataParameter::clear_num_scales() {
  num_scales_ = 224u;
  clear_has_num_scales();
}
inline ::google::protobuf::uint32 CtxDataParameter::num_scales() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.num_scales)
  return num_scales_;
}
inline void CtxDataParameter::set_num_scales(::google::protobuf::uint32 value) {
  set_has_num_scales();
  num_scales_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.num_scales)
}

// optional float jit_scale = 14 [default = 224];
inline bool CtxDataParameter::has_jit_scale() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void CtxDataParameter::set_has_jit_scale() {
  _has_bits_[0] |= 0x00000400u;
}
inline void CtxDataParameter::clear_has_jit_scale() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void CtxDataParameter::clear_jit_scale() {
  jit_scale_ = 224;
  clear_has_jit_scale();
}
inline float CtxDataParameter::jit_scale() const {
  // @@protoc_insertion_point(field_get:caffe.CtxDataParameter.jit_scale)
  return jit_scale_;
}
inline void CtxDataParameter::set_jit_scale(float value) {
  set_has_jit_scale();
  jit_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.CtxDataParameter.jit_scale)
}
